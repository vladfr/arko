...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	...
	0x71, 0x62, 0x7a, 0x2a, 0xd4, 0x14, 0x18, 0xd7, 0x68, 0x36, 0x23, 0x17, 0x17, 0xc2, 0x4a, 0x21,
	0x6d, 0x2e, 0xe6, 0xa0, 0xd2, 0x3c, 0x21, 0x41, 0x3d, 0x74, 0x67, 0x48, 0xf1, 0xeb, 0xa1, 0x9a,
	0xa9, 0xc4, 0x20, 0xa4, 0xc7, 0xc5, 0xe6, 0x52, 0x54, 0x49, 0xbc, 0x7a, 0x03, 0x2e, 0x8e, 0xa0,
	0xfc, 0x9c, 0x9c, 0xa4, 0xc4, 0xe4, 0x6c, 0xe2, 0x74, 0x24, 0xb1, 0x81, 0x83, 0xc5, 0x18, 0x10,
	0x00, 0x00, 0xff, 0xff, 0xc4, 0x96, 0xd9, 0xb6, 0x28, 0x01, 0x00, 0x00,
}
...
type MyPipelineClient interface {
	...
	DryRun(ctx context.Context, in *MyPipelineConfig, opts ...grpc.CallOption) (*PipelineStatus, error)
	Rollback(ctx context.Context, in *MyPipelineConfig, opts ...grpc.CallOption) (*PipelineStatus, error)
}
...
func (c *myPipelineClient) DryRun(ctx context.Context, in *MyPipelineConfig, opts ...grpc.CallOption) (*PipelineStatus, error) {
	out := new(PipelineStatus)
	err := c.cc.Invoke(ctx, "/MyPipeline/DryRun", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *myPipelineClient) Rollback(ctx context.Context, in *MyPipelineConfig, opts ...grpc.CallOption) (*PipelineStatus, error) {
	out := new(PipelineStatus)
	err := c.cc.Invoke(ctx, "/MyPipeline/Rollback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MyPipelineServer interface {
	...
	DryRun(context.Context, *MyPipelineConfig) (*PipelineStatus, error)
	Rollback(context.Context, *MyPipelineConfig) (*PipelineStatus, error)
}
...
func (*UnimplementedMyPipelineServer) DryRun(ctx context.Context, req *MyPipelineConfig) (*PipelineStatus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DryRun not implemented")
}
func (*UnimplementedMyPipelineServer) Rollback(ctx context.Context, req *MyPipelineConfig) (*PipelineStatus, error) {
...
func _MyPipeline_DryRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MyPipelineConfig)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MyPipelineServer).DryRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MyPipeline/DryRun",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MyPipelineServer).DryRun(ctx, req.(*MyPipelineConfig))
	}
	return interceptor(ctx, in, info, handler)
}

func _MyPipeline_Rollback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MyPipelineConfig)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MyPipelineServer).Rollback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MyPipeline/Rollback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MyPipelineServer).Rollback(ctx, req.(*MyPipelineConfig))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MyPipeline_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DryRun",
			Handler:    _MyPipeline_DryRun_Handler,
		},
		{
			MethodName: "Rollback",
			Handler:    _MyPipeline_Rollback_Handler,
		},
	},
